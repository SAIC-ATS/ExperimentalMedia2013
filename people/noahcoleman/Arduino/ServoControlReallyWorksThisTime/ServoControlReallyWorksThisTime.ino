...
byte buffer[NUM_BYTES_EXPECTED] = { 0, 0 ,0 };  
...
const byte SERVO_PINS[NUM_SERVO_PINS] = { 9, 10, 11 };//array with pin numbers for servos
byte servoValues[NUM_SERVO_PINS] = { 0, 0, 0 };
